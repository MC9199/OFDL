...
parser.add_argument('--ntu_path', type=str, default='/home/user06/NTURain/Dataset_Training_Synthetic/',
                                      help="Path of the original NTURain datasets, (default: None)")
parser.add_argument('--train_path', type=str, default='/home/user06/MC/S2VD-master-80/makedata/train/',
