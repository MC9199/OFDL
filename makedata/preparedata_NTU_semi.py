...
parser.add_argument('--ntu_path_semi', type=str, default='/home/user06/NTURain/Dataset_Testing_RealRain/',
                                 help="Path to save the original NTURain datasets, (default: None)")
parser.add_argument('--train_path', type=str, default='/home/user06/MC/S2VD-master-80/makedata/train_semi/',
